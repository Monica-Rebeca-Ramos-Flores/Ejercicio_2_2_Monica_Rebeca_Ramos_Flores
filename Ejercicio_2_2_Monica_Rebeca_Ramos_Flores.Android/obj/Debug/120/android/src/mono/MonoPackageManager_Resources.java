...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Ejercicio_2_2_Monica_Rebeca_Ramos_Flores.Android.dll" comes first in this list. */
		"Ejercicio_2_2_Monica_Rebeca_Ramos_Flores.Android.dll",
		"Ejercicio_2_2_Monica_Rebeca_Ramos_Flores.dll",
		"FormsViewGroup.dll",
		"SignaturePad.dll",
